          ...
          <div className="row pt-5">
            ...
            <div className="position-absolute animatedarrow1 text-end d-none d-md-block">
              ...
              <div className="position-absolute animatedarrow2 text-end d-none d-md-block"style={{transform:`rotate(180deg)`}}>
                ...
                {data.collectionShirts.nodes?.filter(name => name.title.includes('Slim')).map((user)=>( 
            ...
            <div className="py-5">
              <Fade right>
                ...
                {data.collectionShirts.nodes?.filter(name => name.title.includes('Classic')).map((user)=>( 
                  <Link to={`/collection/${user.handle}?o=${user.id}`}>
            ...
            <div className="position-relative pt-3">
              ...
              <Fade right>
                ...
                {data.collectionShirts.nodes?.filter(name => name.title.includes('Casual')).map((user)=>( 
                  <Link to={`/collection/${user.handle}?o=${user.id}`}>
                  <h4 className={`primary_color pt-3 Aftika_Light font_xs`}>
                  Shop Now
                  </h4>
