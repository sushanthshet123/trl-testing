...
import {  dottedBorder} from "./cart.module.css"
      ...
      <div className={`mt-5 py-5 container`}>
        {emptyCart ? (
          <div className='text-center pt-5'>
            <h1 className="Aftika_Regular py-3 mt-5 mt-md-0">Your cart is empty</h1>
            <p className="mb-2 mb-md-4">Continue Shopping</p>
            <div className={`${dottedBorder}`}></div>
            <div className="d-grid d-md-block mt-5">
              <button className="bgblack text-white rounded-0 px-5 py-3"><Link to="/products">ENTER</Link></button>
            </div>
          </div>
        ) : (
            ...
            <div className="row pb-5 ">
              <div className="col-md-12 border-bottom pb-3 px-0">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <img src="/cart/cart-svg.svg" alt="" className="img-fluid d-inline mb-1" />
                    <span className="ps-3 font_xs Aftika_Light">MY SHOPPING CART</span>
                  </div>
