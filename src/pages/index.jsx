...
function Hero() {
  ...
  return (
    <section>
      ...
      {show &&
        <section className="modalColor">
          <div className="modal-backdrop-cs"></div>
          <div className="modalUP">
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="row px-4 pb-5 align-items-center">
                  <div className="col-md-6">
                    <img src="/late-delivary.png" alt="Free Delivary" />
                  </div>
                  <div className="col-md-6 pt-4">
                    <p>We are occasionally encountering delays in shipping.</p>
                  </div>
                </div>
              </div>
            </div>
